...
if __name__ == "__main__":
    ...
    from 
    (SELECT 
        STATS_DTTM, PLTFOM_TP_CODE, ADVRTS_PRDT_CODE, ADVRTS_TP_CODE, SITE_CODE, MEDIA_SCRIPT_NO,
        ITL_TP_CODE, TOT_EPRS_CNT, CLICK_CNT, ADVER_ID, MEDIA_ID
    ...
    LEFT JOIN (
        ...
        GROUP BY
            STATS_DTTM, SITE_CODE, MEDIA_CATE_CODE, PLTFOM_TP_CODE;
    """
    dt_index = pd.date_range(start='20200623', end='20200822')
    ...
    file_name = project_name + '/LPM_DAILY_DATA_20200923_20200923.csv'
